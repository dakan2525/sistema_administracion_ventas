...
@section('content')
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item active"><a href="{{ route('presentacion.index') }}">Presentación</a></li>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nombre" id="nombre" class="form-control"
                            value="{{ old('nombre', $presentacion->caracteristica->nombre) }}">
                        @error('nombre')
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="descripcion" id="descripcion" rows="10" class="form-control">{{ old('descripcion', $presentacion->caracteristica->descripcion) }}</textarea>
                        @error('descripcion')
                            <small class="text-danger">{{ '*' . $message }}</small>
                        @enderror
                    </div>
