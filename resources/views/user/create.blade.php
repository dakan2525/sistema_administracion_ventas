                    ...
                    <form action="{{ route('user.store') }}" method="POST">
                        ...
                        <div class="row g-3 col-12 text-start">
                            ...
                            <div class="row mb-4 col-12 ">
                                <label for="email" class="col-sm-3 col-form-label text-end px-4">Correo eléctronico:
                                </label>
                                <div class="col-sm-6">
                            ...
                            <div class="row mb-4 col-12">
                                <label for="password_confirm" class="col-sm-3 col-form-label text-end px-4">Confirmar
                                    contraseña:
                                </label>
                                <div class="col-sm-6">
                                    <input type="password" placeholder="Vuelva a escribir su contraseña"
                            ...
                            {{-- roles --}}
                            <div class="row mb-4 col-12">
                                <label for="role" class="col-sm-3 col-form-label text-end px-4">Seleccione un rol:
                                </label>
                                <div class="col-sm-6">
