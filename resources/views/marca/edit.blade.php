...
@section('content')
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item active"><a href="{{ route('marca.index') }}">marcas</a></li>
            ...
            <form action="{{ route('marca.update', ['marca' => $marca]) }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="descripcion" id="descripcion" rows="10" class="form-control">{{ old('descripcion', $marca->caracteristica->descripcion) }}</textarea>
                        @error('descripcion')
                            <small class="text-danger">{{ '*' . $message }}</small>
                        @enderror
                    </div>
